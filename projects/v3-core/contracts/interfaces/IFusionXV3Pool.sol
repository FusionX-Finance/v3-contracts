...
/// @title The interface for a FusionX V3 Pool
/// @notice A FusionX pool facilitates swapping and automated market making between any two assets that strictly conform
